 ...
 */
AppStateSimpleTexture_11::AppStateSimpleTexture_11(App_11 *p_app) :
	AppState_11(p_app)
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleTexture_11::ctor()" << std::endl;
}

//-----------------------------------------------------------------------------

AppStateSimpleTexture_11::~AppStateSimpleTexture_11()
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleTexture_11::dtor()" << std::endl;
}

//-----------------------------------------------------------------------------

void AppStateSimpleTexture_11::Init() 
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleTexture_11::Init()" << std::endl;
...
void AppStateSimpleTexture_11::Reinit()
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleTexture_11::Reinit()" << std::endl;
}

//-----------------------------------------------------------------------------

AppState_11* AppStateSimpleTexture_11::Update(
    ...
    DirectX::Mouse* p_mouse,        DirectX::Mouse::ButtonStateTracker & p_mouseButtons)
{
    ...
    /*
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleTexture_11::Update(" << elapsedSeconds << ")" << std::endl;
	//*/
...
void AppStateSimpleTexture_11::Draw(DX::DeviceResources_11* p_deviceResources)
{
...
void AppStateSimpleTexture_11::Clear(DX::DeviceResources_11* p_deviceResources)
{
...
void AppStateSimpleTexture_11::HandleCleanup()
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleTexture_11::HandleCleanup()" << std::endl;
}

//-----------------------------------------------------------------------------

void AppStateSimpleTexture_11::CreateDeviceDependentResources(DX::DeviceResources_11* p_deviceResources)
{
    GetLogStream(SeverityInfo)
        << "AppStateSimpleTexture_11::CreateDeviceDependentResources()" << std::endl;
...
void AppStateSimpleTexture_11::CreateWindowSizeDependentResources(DX::DeviceResources_11* p_deviceResources)
{
    (void)p_deviceResources;

    GetLogStream(SeverityInfo)
        << "AppStateSimpleTexture_11::CreateWindowSizeDependentResources()" << std::endl;
}

//-----------------------------------------------------------------------------

void AppStateSimpleTexture_11::ResetResources()
{
    GetLogStream(SeverityInfo)
        << "AppStateSimpleTexture_11::ResetRessources()" << std::endl;
