...
// Constructor for DeviceResources_11.
DeviceResources_11::DeviceResources_11(
...
void DeviceResources_11::CreateDeviceResources()
{
...
void DeviceResources_11::CreateWindowSizeDependentResources()
{
    if (!m_window)
    {
...
void DeviceResources_11::SetWindow(HWND window, int width, int height)
{
    m_window = window;
...
bool DeviceResources_11::WindowSizeChanged(int width, int height)
{
    RECT newRc;
...
void DeviceResources_11::HandleDeviceLost()
{
    if (m_deviceNotify)
    {
...
void DeviceResources_11::Present()
{
    HRESULT hr;
    if (m_options & c_AllowTearing)
    {
...
void DeviceResources_11::CreateFactory()
{
...
void DeviceResources_11::GetHardwareAdapter(IDXGIAdapter1** ppAdapter)
{
    *ppAdapter = nullptr;
...
void DeviceResources_11::UpdateColorSpace()
{
