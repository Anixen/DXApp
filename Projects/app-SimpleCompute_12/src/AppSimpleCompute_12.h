 ...
 *
 * @class AppSimpleCompute_12
 *
 *
 * @file src/AppSimpleCompute_12.h
 * @author Olivier Falconnet
 * @date 20211023 - File creation
 */

#ifndef NXN_APP_SIMPLE_COMPUTE_12
#define NXN_APP_SIMPLE_COMPUTE_12
...
namespace nxn {
    ...
    class AppSimpleCompute_12 : public App_12 {

    public:
                        AppSimpleCompute_12     (std::unique_ptr<DX::DeviceResources_12> & p_deviceResources);
                        ~AppSimpleCompute_12    ();
...
#endif // !NXN_APP_SIMPLE_COMPUTE_12
