 ...
 *
 * @class AppStateSimpleCompute_12
 *
 *
 * @file src/AppStateSimpleCompute_12.h
 * @author Olivier Falconnet
 * @date 20211027 - File creation
 */

#ifndef NXN_APP_STATE_SIMPLE_COMPUTE_12
#define NXN_APP_STATE_SIMPLE_COMPUTE_12
...
class AppStateSimpleCompute_12 : public AppState_12 {

public:
	                                                                    AppStateSimpleCompute_12            (App_12* p_app);
	                                                                    ~AppStateSimpleCompute_12           ();
...
private:
    ...
    virtual         void                                                ResetResources                      ();
                    ...
                    void                                                ResetWindow                         ();
                    void                                                UpdateFractalData                   (DX::DeviceResources_12* p_deviceResources);
                    ...
                    void                                                AsyncComputeThreadProc              (DX::DeviceResources_12* p_deviceResources);
