 ...
 */
AppStateSimpleMSAA_11::AppStateSimpleMSAA_11(App_11 *p_app)
    : AppState_11(p_app)
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleMSAA_11::ctor()" << std::endl;
}

//-----------------------------------------------------------------------------

AppStateSimpleMSAA_11::~AppStateSimpleMSAA_11()
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleMSAA_11::dtor()" << std::endl;
}

//-----------------------------------------------------------------------------

void AppStateSimpleMSAA_11::Init() 
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleMSAA_11::Init()" << std::endl;
...
void AppStateSimpleMSAA_11::Reinit()
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleMSAA_11::Reinit()" << std::endl;
}

//-----------------------------------------------------------------------------

AppState_11* AppStateSimpleMSAA_11::Update(
    ...
    DirectX::Mouse* p_mouse,        DirectX::Mouse::ButtonStateTracker & p_mouseButtons)
{
    ...
    /*
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleMSAA_11::Update(" << elapsedSeconds << ")" << std::endl;
	//*/
...
void AppStateSimpleMSAA_11::Draw(DX::DeviceResources_11* p_deviceResources)
{
...
void AppStateSimpleMSAA_11::Clear(DX::DeviceResources_11* p_deviceResources)
{
    auto context = p_deviceResources->GetD3DDeviceContext();
...
void AppStateSimpleMSAA_11::HandleCleanup()
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleMSAA_11::HandleCleanup()" << std::endl;
}

//-----------------------------------------------------------------------------

void AppStateSimpleMSAA_11::CreateDeviceDependentResources(DX::DeviceResources_11* p_deviceResources)
{
    GetLogStream(SeverityInfo)
        << "AppStateSimpleMSAA_11::CreateDeviceDependentResources()" << std::endl;
...
void AppStateSimpleMSAA_11::CreateWindowSizeDependentResources(DX::DeviceResources_11* p_deviceResources)
{
    GetLogStream(SeverityInfo)
        << "AppStateSimpleMSAA_11::CreateWindowSizeDependentResources()" << std::endl;
...
void AppStateSimpleMSAA_11::ResetResources()
{
    GetLogStream(SeverityInfo)
        << "AppStateSimpleMSAA_11::ResetRessources()" << std::endl;
