 ...
 */
AppStateSimpleLighting_11::AppStateSimpleLighting_11(App_11 *p_app) :
	AppState_11(p_app)
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleLighting_11::ctor()" << std::endl;
}

//-----------------------------------------------------------------------------

AppStateSimpleLighting_11::~AppStateSimpleLighting_11()
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleLighting_11::dtor()" << std::endl;
}

//-----------------------------------------------------------------------------

void AppStateSimpleLighting_11::Init() 
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleLighting_11::Init()" << std::endl;
...
void AppStateSimpleLighting_11::Reinit()
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleLighting_11::Reinit()" << std::endl;
}

//-----------------------------------------------------------------------------

AppState_11* AppStateSimpleLighting_11::Update(
    ...
    DirectX::Mouse* p_mouse,        DirectX::Mouse::ButtonStateTracker & p_mouseButtons)
{
    ...
    /*
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleLighting_11::Update(" << elapsedSeconds << ")" << std::endl;
	//*/
...
void AppStateSimpleLighting_11::Draw(DX::DeviceResources_11* p_deviceResources)
{
...
void AppStateSimpleLighting_11::Clear(DX::DeviceResources_11* p_deviceResources)
{
...
void AppStateSimpleLighting_11::HandleCleanup()
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleLighting_11::HandleCleanup()" << std::endl;
}

//-----------------------------------------------------------------------------

void AppStateSimpleLighting_11::CreateDeviceDependentResources(DX::DeviceResources_11* p_deviceResources)
{
    GetLogStream(SeverityInfo)
        << "AppStateSimpleLighting_11::CreateDeviceDependentResources()" << std::endl;
...
void AppStateSimpleLighting_11::CreateWindowSizeDependentResources(DX::DeviceResources_11* p_deviceResources)
{
    GetLogStream(SeverityInfo)
        << "AppStateSimpleLighting_11::CreateWindowSizeDependentResources()" << std::endl;
...
void AppStateSimpleLighting_11::ResetResources()
{
    GetLogStream(SeverityInfo)
        << "AppStateSimpleLighting_11::ResetRessources()" << std::endl;
