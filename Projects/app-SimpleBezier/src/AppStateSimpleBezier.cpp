 ...
 */
AppStateSimpleBezier::AppStateSimpleBezier(App *p_app) 
    : AppState(p_app)
...
AppState* AppStateSimpleBezier::Update(DX::StepTimer const& p_timer,
...
void AppStateSimpleBezier::Draw(DX::DeviceResources* p_deviceResources)
{
...
void AppStateSimpleBezier::Clear(DX::DeviceResources * p_deviceResources)
{
...
void AppStateSimpleBezier::CreateShaders(DX::DeviceResources * p_deviceResources)
{
