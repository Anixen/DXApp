 ...
 *
 * @class AppSimpleLighting_12
 *
 *
 * @file src/AppSimpleLighting_12.h
 * @author Olivier Falconnet
 * @date 20211025 - File creation
 */

#ifndef NXN_APP_SIMPLE_LIGHTING_12
#define NXN_APP_SIMPLE_LIGHTING_12
...
namespace nxn {
    ...
    class AppSimpleLighting_12 : public App_12 {

    public:
                        AppSimpleLighting_12    (std::unique_ptr<DX::DeviceResources_12> & p_deviceResources);
                        ~AppSimpleLighting_12   ();
...
#endif // !NXN_APP_SIMPLE_LIGHTING_12
