 ...
 *
 * @class AppStateSimpleTriangle_12
 *
 *
 * @file src/AppStateSimpleTriangle_12.h
 * @author Olivier Falconnet
 * @date 20211014 - File creation
 */

#ifndef NXN_APP_STATE_SIMPLE_TRIANGLE_12
#define NXN_APP_STATE_SIMPLE_TRIANGLE_12
...
class AppStateSimpleTriangle_12 : public AppState_12 {

public:
	                                                    AppStateSimpleTriangle_12           (App_12* p_app);
	                                                    ~AppStateSimpleTriangle_12          ();
