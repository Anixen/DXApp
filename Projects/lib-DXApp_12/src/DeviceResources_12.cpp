 ...
 * (requires DirectX 12.0 Runtime)
 *
 * @class DeviceRessources_12
 *
 * @file src/DeviceRessources_12.cpp
 */
...
// Constructor for DeviceResources_12.
DeviceResources_12::DeviceResources_12(
...
// Destructor for DeviceResources_12.
DeviceResources_12::~DeviceResources_12()
{
...
void DeviceResources_12::CreateDeviceResources()
{
#if defined(_DEBUG)
...
void DeviceResources_12::CreateWindowSizeDependentResources()
{
    if (!m_window)
    {
...
void DeviceResources_12::SetWindow(HWND window, int width, int height)
{
    m_window = window;
...
bool DeviceResources_12::WindowSizeChanged(int width, int height)
{
    RECT newRc;
...
void DeviceResources_12::HandleDeviceLost()
{
    if (m_deviceNotify)
    {
...
void DeviceResources_12::Prepare(D3D12_RESOURCE_STATES beforeState)
{
...
void DeviceResources_12::Present(D3D12_RESOURCE_STATES beforeState)
{
...
void DeviceResources_12::WaitForGpu() noexcept
{
...
void DeviceResources_12::MoveToNextFrame()
{
...
void DeviceResources_12::GetAdapter(IDXGIAdapter1** ppAdapter)
{
    *ppAdapter = nullptr;
...
void DeviceResources_12::UpdateColorSpace()
{
