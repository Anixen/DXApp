 ...
 */
AppStateSimpleInstancing::AppStateSimpleInstancing(App *p_app)
    : AppState(p_app)
...
void AppStateSimpleInstancing::Draw(DX::DeviceResources* p_deviceResources)
{
...
void AppStateSimpleInstancing::Clear(DX::DeviceResources * p_deviceResources)
{
