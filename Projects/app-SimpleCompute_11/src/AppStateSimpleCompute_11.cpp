...
AppStateSimpleCompute_11::~AppStateSimpleCompute_11()
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleCompute_11::dtor()" << std::endl;
}

//-----------------------------------------------------------------------------

void AppStateSimpleCompute_11::Init() 
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleCompute_11::Init()" << std::endl;
...
void AppStateSimpleCompute_11::Reinit()
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleCompute_11::Reinit()" << std::endl;
}

//-----------------------------------------------------------------------------

AppState_11* AppStateSimpleCompute_11::Update(
    ...
    DirectX::Mouse* p_mouse,        DirectX::Mouse::ButtonStateTracker & p_mouseButtons)
{
    ...
    /*
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleCompute_11::Update(" << elapsedSeconds << ")" << std::endl;
	//*/
...
void AppStateSimpleCompute_11::Draw(DX::DeviceResources_11* p_deviceResources)
{
...
void AppStateSimpleCompute_11::Clear(DX::DeviceResources_11* p_deviceResources)
{
...
void AppStateSimpleCompute_11::HandleCleanup()
{
	GetLogStream(SeverityInfo)
		<< "AppStateSimpleCompute_11::HandleCleanup()" << std::endl;
}

//-----------------------------------------------------------------------------

void AppStateSimpleCompute_11::CreateDeviceDependentResources(DX::DeviceResources_11* p_deviceResources)
{
    GetLogStream(SeverityInfo)
        << "AppStateSimpleCompute_11::CreateDeviceDependentResources()" << std::endl;
...
void AppStateSimpleCompute_11::CreateWindowSizeDependentResources(DX::DeviceResources_11* p_deviceResources)
{
    GetLogStream(SeverityInfo)
        << "AppStateSimpleCompute_11::CreateWindowSizeDependentResources()" << std::endl;
...
void AppStateSimpleCompute_11::ResetResources()
{
    GetLogStream(SeverityInfo)
        << "AppStateSimpleCompute_11::ResetResources()" << std::endl;
...
void AppStateSimpleCompute_11::ResetWindow()
{
